...
// /**
// * Class for scailing ingredients to the number of people
// */
// public class Scalar {
...
// /**
// * This function takes in a recipe and scales it according to the per person previous amount. If
// * the amount is less than 1 after scaling it sets the amount of that Ingredient to 1, as it has
// * not been removed.
// *
